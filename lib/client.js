...
function S3Client(params, username) {
	...
	port: process.env.S3_STORE_PORT || 6788,
	bucket: process.env.S3_STORE_BUCKET_NAME || 'changeme',
	style: process.env.S3_STORE_STYLE || 'path',
	endpoint: process.env.S3_STORE_HOST || '127.0.0.1',
	secure: (process.env.S3_STORE_PROTO === 'http') ? false : true,
    });
